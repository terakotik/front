 ...
 * Версия 2.4 - Интеграция с Mistral API
...
(function() {
    ...
    async function generateTest(userQuestion) {
        ...
        try {
            const payload = {
                model: "mistral-small-latest", // Используем модель Mistral
                messages: [{ role: "user", content: prompt }],
                response_format: { type: "json_object" } // Просим Mistral вернуть JSON
            };
            ...
            const response = await fetch(apiUrl, {
                ...
                headers: {
                    ...
                    'Authorization': `Bearer ${apiKey}` // Используем Bearer токен
                },
            ...
            // ИЗМЕНЕНИЕ: Извлекаем JSON из ответа Mistral
